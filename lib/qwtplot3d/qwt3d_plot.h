	...
	*/
	class QWT3D_EXPORT Plot3D : public QGLWidget
	{
		Q_OBJECT
			...
			double xShift() const//!< Returns shift along X axis (object coordinates)
			{
				return xShift_;
			}
			double yShift() const//!< Returns shift along Y axis (object coordinates)
			{
				return yShift_;
			}
			double zShift() const//!< Returns shift along Z axis (object coordinates)
			{
				return zShift_;
			}
			...
			double xScale() const//!< Returns scaling for X values [0..inf]
			{
				return xScale_;
			}
			double yScale() const//!< Returns scaling for Y values [0..inf]
			{
				return yScale_;
			}
			double zScale() const//!< Returns scaling for Z values [0..inf]
			{
				return zScale_;
			}

			double zoom() const	 //!< Returns zoom (0..inf)
			{
				return zoom_;
			}

			bool ortho() const	 //!< Returns orthogonal (true) or perspective (false) projection
			{
				return ortho_;
			}
			...
			int isolines() const //!< Returns number of isolines
			{
				return isolines_;
			}
